...
class BooksApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_2 = Book.objects.create(name='Test book 2', price=50, author_name='Author 1')
        self.book_3 = Book.objects.create(name='Test book 3', price=100, author_name='Author 2')
